...
public class WalletUserInfoServiceImpl implements WalletUserInfoService {

    private final Logger logger = LoggerFactory.getLogger(WalletUserInfoServiceImpl.class);

    private static final WalletUserInfoServiceImpl INSTANCE = new WalletUserInfoServiceImpl();

    private SessionFactory factory;

    private WalletUserInfoServiceImpl() {
        try {
